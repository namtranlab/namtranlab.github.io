...
<div class="result-box" markdown="1">The stopped process $$Y_n = M_{n \wedge T}$$ is always a martingale with respect to $$\{\mathcal{F}_n\}$$. In particular, $$E[M_{n \wedge T}] = E[M_0]$$ for every finite $$n$$.</div>
